...
export const CONTINENT_DEFS: ContinentDef[] = [
  ...
  { id: 'eastern_europe',          nameKo: '동유럽·러시아',       isStart: false, ports: ['st_petersburg'],                                                                   box: [18,68,52,46] },
  ...
  { id: 'east_africa',             nameKo: '동아프리카',          isStart: false, ports: ['zanzibar','mombasa'],                                                       box: [12,12,52,-14] },
  { id: 'southern_africa',         nameKo: '남아프리카',          isStart: false, ports: ['cape_town'],                                                               box: [8,-18,38,-42] },
  { id: 'north_america',           nameKo: '북아메리카',          isStart: false, ports: ['new_york','washington_dc','los_angeles','new_orleans'],                         box: [-130,54,-60,24] },
